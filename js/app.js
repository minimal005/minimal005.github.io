(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery-big__slider")) swiper = new swiper_core_Swiper(".gallery-big__slider", {
        ...
        if (document.querySelector(".gallery-small__slider")) swiper2 = new swiper_core_Swiper(".gallery-small__slider", {
            modules: [ Controller ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
